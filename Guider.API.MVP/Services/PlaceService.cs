namespace Guider.API.MVP.Services
{
    ...
    using Microsoft.Extensions.Primitives; //  для IChangeToken
    public class PlaceService
    {
       ...
       public async Task<JsonDocument> GetPlacesWithGeoWithStatusWithTagsAsync(Dictionary<string, string> filter = null)
        ...
        /// <summary>
        /// Получить токен отслеживания изменений для кеша провинций.
        /// Если этот токен будет отменен, все связанные записи кеша сбросятся.
        /// </summary>
        public IChangeToken GetProvincesChangeToken()
        {
            return new CancellationChangeToken(_provincesCts.Token);
        }

        /// <summary>
        /// Сбросить кеш всех активных провинций.
        /// Вызывать при изменении полей: address.province, status, category.
        /// </summary>
        public void InvalidateProvincesCache()
        {
            // Отменяем текущий токен (это сбросит кеш)
            _provincesCts.Cancel();
